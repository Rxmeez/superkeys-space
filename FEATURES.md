...
- **Tidier Settings.** Five tabs: General (on/off, preferences, updates, tour), Keys (the chord reference), Apps, Permissions, Advanced (config file, desktop numbering, Reset Access).
