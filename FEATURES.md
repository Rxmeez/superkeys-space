...
| 71 | **App icon matches the logo** | The app icon is still the original Caps Lock keycap, while the menu bar, site and favicon use the moon-and-stars mark. It shows in every dialog (the which-copy prompt, What's New, the first-launch warning). Redraw it as the moon-and-stars mark on a dark keycap, and give Superkeys Dev a tinted variant so the two are easy to tell apart. | S |
