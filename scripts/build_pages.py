      ...
      <div class="prose">
        ...
        <ul>
          <li><strong>Key mapping.</strong> While it runs, Caps Lock and right ⌘ are remapped to F18 and F19 at the
            ...
            Superkeys ever crashes, a small helper restores them within two seconds.</li>
        ...
        <h2>What it keeps</h2>
        <p>
          Your app keys and settings, in <code>~/Library/Preferences/space.superkeys.plist</code> on your Mac. Nothing
          else. Settings → Export writes the same information to a JSON file only if you ask it to.
        </p>
