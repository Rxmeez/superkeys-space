...
PRIVACY = """      <header>
      ...
      <div class="prose">
        ...
        <p>
          ...
          your browser. A problem report fills in the app's version, your macOS version, your Mac's model and a short
          diagnostics summary (whether the keys are on, how many app keys you have, which keyboards are connected), never
          which keys you use or anything you typed. Nothing is sent unless you submit the form, and you can edit or
          delete any of it first.
        </p>
